  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMessage(json.error ?? t("errorUpdate"));
      }
    } catch {
    ...
    return (
      <PageShell>
        <div className="card bg-white p-8 text-center space-y-4">
          <p className="text-muted">{t("notLoggedIn")}</p>
          <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 flex items-center gap-1.5 text-sm text-muted">
                  ...
                  {t("regionFormat", { region: user.region })}
                </p>
            ...
            {!isEditing ? (
              ...
              <form onSubmit={handleUpdate} className="space-y-4">
                <div className="form-control gap-1">
                  <label htmlFor="nom" className="label-text font-semibold">{t("lastName")}</label>
                  <input
                    id="nom"
                    type="text"
                    value={nom}
                ...
                <div className="form-control gap-1">
                  <label htmlFor="prenom" className="label-text font-semibold">{t("firstName")}</label>
                  <input
                    id="prenom"
                    type="text"
                    value={prenom}
                ...
                <div className="form-control gap-1">
                  <label htmlFor="region" className="label-text font-semibold">{t("region")}</label>
                  <select
                    id="region"
                    value={region}
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button
                    ...
                    disabled={saving}
                  >
                    {saving ? <span className="loading loading-spinner" /> : tc("save")}
                  </button>
                </div>
              </form>
            )}
